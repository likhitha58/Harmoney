  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/dreamframe" element={<ProtectedRoute><DreamFrame /></ProtectedRoute>} />
        <Route path="/budgetbuddy" element={<ProtectedRoute><BudgetBuddy /></ProtectedRoute>} />
        <Route path="/activegoals" element={<ProtectedRoute><ActiveGoals /></ProtectedRoute>} />
        <Route path="/activegoals/:id" element={<ProtectedRoute><ActiveGoalDetails /></ProtectedRoute>} />
        <Route path="/dashboard" element={<ProtectedRoute><Dashboard /></ProtectedRoute>} />
        <Route path="/pastgoals" element={<ProtectedRoute><PastGoals /></ProtectedRoute>} />
      </Routes>

      {/* Toastify container (autoClose works globally here) */}
     <ToastContainer
  position="top-right"
  autoClose={3000}
